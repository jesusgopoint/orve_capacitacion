  ...
  return (
    <section id="contacto" className="bg-gray-50 py-16 md:py-24">
      <div className="container">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 typewriter">Contáctanos ahora</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-6" id="contact-form-homepage">
              ...
              <button
                type="submit"
                className="w-full md:w-auto bg-primary text-white py-3 px-8 rounded-lg font-semibold hover:bg-blue-400 transition-colors block md:inline-block mx-auto md:mx-0"
              >
                Enviar
              </button>
            </form>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex gap-4 flex-wrap">
                ...
                {/* WhatsApp */}
                <a href="https://wa.me/56986528382?text=Estoy%20en%20su%20sitio%20web%20y%20quería%20pedirles%20más%20información" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-lg flex items-center justify-center hover:opacity-80 transition-opacity flex-shrink-0">
