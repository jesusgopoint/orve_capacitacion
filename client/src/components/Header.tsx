...
export default function Header() {
  ...
  const navItems = [
    ...
    { label: "Orve E-Learning", href: "https://orvelearning.cl/", isExternal: true, isPrimary: true },
  ...
  const servicesSubmenu = [
    ...
    // { label: "Team Building", href: "/team-building" }, // Temporalmente oculto
  ];
              ...
              <a
                ...
                className={`text-base font-medium transition-colors flex items-center gap-1 ${
                  item.label === "Contacto"
                    ...
                    : item.isPrimary
                    ? "text-black hover:text-primary underline"
